...
async function initializeDataFolder() {
  try {
    const { DATA_DIR, CONFIG_PATH, DEVIS_DIR, FACTURES_DIR, CONFIG_TEMPLATE_PATH } = getPaths()
 ...
 */
function getYearFolder(type, year) {
...
module.exports = {
  ...
  get CONFIG_PATH() { return getPaths().CONFIG_PATH },
  get DEVIS_DIR() { return getPaths().DEVIS_DIR },
  get FACTURES_DIR() { return getPaths().FACTURES_DIR },
